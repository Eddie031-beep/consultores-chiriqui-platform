...
$routes = [
    ...
    'GET' => [
        ...
        '/empresa/vacantes/cerrar/(?P<id>\d+)' => 'EmpresaController@cerrarVacante', // Nueva ruta
        '/empresa/vacantes/abrir/(?P<id>\d+)' => 'EmpresaController@abrirVacante',   // Nueva ruta: Reabrir
        '/empresa/vacantes/facturar/(?P<vacante_id>\d+)' => 'EmpresaController@generarFactura', // Nueva ruta: Facturar vacante específica
        '/empresa/vacantes/interacciones/(?P<vacante_id>\d+)' => 'EmpresaController@verInteracciones', // Nueva ruta: Ver reporte de vistas
        '/empresa/facturar-corte' => 'EmpresaController@generarFactura',             // Mantenemos para debug o uso general si se requiere
        '/empresa/candidatos' => 'EmpresaController@candidatos',
        '/empresa/postulantes' => 'EmpresaController@postulantes',
        ...
        '/consultora/facturacion/descargar/(?P<id>\d+)' => 'FacturacionController@descargarPDF',
    ...
    'POST' => [
        ...
        '/empresa/facturacion/confirmar' => 'EmpresaController@confirmarFactura',
        '/empresa/facturacion/pagar' => 'EmpresaController@pagarFactura',
